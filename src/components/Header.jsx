...
const Header = () => {
  ...
  const linkStyles =
    "text-base tracking-wider transition-colors hover:text-gray-300 z-50 text-white no-underline";
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[100] flex justify-between items-center py-4 px-6 md:px-20 bg-black/10 backdrop-blur-md border-b border-white/5">
      ...
      <Link to="/" className="z-50 no-underline">
        <h2
          translate="no"
          className="text-4xl md:text-5xl font-black text-white italic tracking-tighter leading-none m-0"
        >
          AZOTH
        </h2>
      </Link>
      ...
      <a
        ...
        className="hidden lg:block bg-[#a7a7a7] text-black py-3 px-8 rounded-full border-none font-medium transition-all duration-500 hover:bg-white cursor-pointer z-50 no-underline text-center text-sm"
      >
        Solutions Deck
      </a>
      ...
      <button
        ...
        className="lg:hidden text-3xl p-2 z-50 text-white bg-transparent border-none outline-none"
      >
